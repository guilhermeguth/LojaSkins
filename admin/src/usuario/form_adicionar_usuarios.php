                ...
                <div class="span12">
                    ...
                    <form id="frm_cad" name="frm_cad" method="post" class="form-horizontal" action="insere_usuario_dados.php">
                        <div class="control-group">
                            ...
                            <div class="controls">
                             <input type="text" name="inp_login" id="inp_login" class="input-xlarge" placeholder="Informe..."  value="" ></div>
                         </div>
                         <div class="control-group">
                            <label class="control-label" for="inp_senha">Senha*:</label>
                            <div class="controls">
                               <input type="password" name="inp_senha" id="inp_senha" class="input-xlarge" placeholder="Informe..." value="" ></div>
                           </div>                        
                            <div class="control-group">
                                <div class="controls">
